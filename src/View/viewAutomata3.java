 ...
 * @author Marco
 */
public class viewAutomata3 extends javax.swing.JFrame {

    /**
     * Creates new form Cadena
     */
    public viewAutomata3() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewAutomata3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewAutomata3().setVisible(true);
            }
        });
    }
